...
namespace BFF.DataVirtualizingCollection.DataAccesses
{
    ...
    internal class RelayBasicAsyncDataAccess<T> : RelayBasicSyncDataAccess<T>, IBasicAsyncDataAccess<T>
    {
        ...
        internal RelayBasicAsyncDataAccess(Func<int, int, T[]> pageFetcher, Func<int> countFetcher, Func<T> placeHolderFactory)
    ...
    /// </summary>
    /// <typeparam name="T">The type of the collection items.</typeparam>
    internal class RelayBasicSyncDataAccess<T> : IBasicSyncDataAccess<T>
    {
        ...
        /// <param name="pageFetcher">A function to fetch a page.</param>
        /// <param name="countFetcher">A function to fetch the item count.</param>
        internal RelayBasicSyncDataAccess(Func<int, int, T[]> pageFetcher, Func<int> countFetcher)
        {

...
namespace BFF.DataVirtualizingCollection.SlidingWindow
{
    ...
    /// </summary>
    /// <typeparam name="T">Type of the collection items.</typeparam>
    public class SlidingWindowBuilder<T> 
            ...
            IIndexAccessBehaviorCollectionBuilder<T>
    {
        ...
        /// </summary>
        /// <returns>The builder itself.</returns>
        public static IPageLoadingBehaviorCollectionBuilder<T> Build(int windowSize, int initialOffset, IScheduler notificationScheduler) => 
            Build(windowSize, initialOffset, notificationScheduler, 100);
        ...
        private SlidingWindowBuilder(int windowSize, int initialOffset, IScheduler notificationScheduler, int pageSize = 100)
        {
        ...
        /// <inheritdoc />
        public ISlidingWindow<T> SyncIndexAccess()
        {
        ...
        /// <inheritdoc />
        public ISlidingWindow<T> AsyncIndexAccess(Func<int, int, T> placeholderFactory, IScheduler backgroundScheduler)
        {
            _indexAccessBehavior = IndexAccessBehavior.Asynchronous;
        ...
        private ISlidingWindow<T> GenerateCollection()
        {
            switch (_indexAccessBehavior, _fetchersKind)
            {
                ...
                case (IndexAccessBehavior.Asynchronous, FetchersKind.NonTaskBased):
                {
                    ...
                    return new AsyncSlidingWindow<T>(
                        _windowSize,
                        _initialOffset,
                        PageStoreFactory, 

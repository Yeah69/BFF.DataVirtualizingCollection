...
namespace BFF.DataVirtualizingCollection.PageStores
{
    ...
    internal class SyncPreloadingNonTaskBasedPageStore<T> : SyncPageStoreBase<T>, ISyncPreloadingNonTaskBasedPageStore<T>
    {
        ...
        internal interface IBuilderOptional<out TItem>
        {
            ...
            ISyncPreloadingNonTaskBasedPageStore<TItem> Build();
        }
        ...
        internal class Builder<TItem> : IBuilderRequired<TItem>, IBuilderOptional<TItem>
        {
            ...
            public ISyncPreloadingNonTaskBasedPageStore<TItem> Build()
            {
                return new SyncPreloadingNonTaskBasedPageStore<TItem>(
                    _dataAccess,
                    _pageReplacementStrategyFactory)
                {
                    PageSize = _pageSize
        ...
        private SyncPreloadingNonTaskBasedPageStore(
